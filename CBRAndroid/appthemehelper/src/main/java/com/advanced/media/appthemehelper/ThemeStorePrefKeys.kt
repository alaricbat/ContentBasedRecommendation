...
interface ThemeStorePrefKeys {
    ...
    companion object {
        ...
        const val CONFIG_PREFS_KEY_DEFAULT = "[[alaricbat_app-theme-helper]]"

        const val KEY_PRIMARY_COLOR = "primary_color"

        const val KEY_MATERIAL_YOU = "material_you"

        const val KEY_DESATURATED_COLOR = "desaturated_color"

        const val KEY_WALLPAPER_ACCENT = "wallpaper_accent"
